...
| [Maccy](https://github.com/p0deje/Maccy) ⭐ 21,305 \| 🐛 157 \| 🌐 Swift \| 📅 2026-08-13 | Clipboard history that just works. Never lose a copied item again.                                                 |
...
* [Stats](https://github.com/exelban/stats) ⭐ 41,374 | 🐛 30 | 🌐 Swift | 📅 2026-08-21 - macOS system monitor for CPU, GPU, memory, disk, and more. `Free` `Open Source`
...
* [Petrichor](https://github.com/kushalpandya/Petrichor) ⭐ 1,609 | 🐛 26 | 🌐 Swift | 📅 2026-08-23 - Offline music player with support for over 20 file formats and a lot of other features. `Free` `Open Source`
...
* [Maccy](https://github.com/p0deje/Maccy) ⭐ 21,305 | 🐛 157 | 🌐 Swift | 📅 2026-08-13 - Lightweight clipboard manager with search. `Free` `Open Source`
* [Pesty](https://github.com/momenbasel/pesty) ⭐ 53 | 🐛 3 | 🌐 Swift | 📅 2026-08-12 - Native clipboard manager with pinboards and keyboard-driven pasting. `Free` `Open Source`
...
* [CodeEdit](https://github.com/CodeEditApp/CodeEdit) ⭐ 22,992 | 🐛 211 | 🌐 Swift | 📅 2026-08-18 - Native code editor for macOS. `Free` `Open Source`
...
* [Quick Look plugins](https://github.com/sindresorhus/quick-look-plugins) ⭐ 18,744 | 🐛 4 | 📅 2026-07-25 - Useful Quick Look plugins for developers. `Free` `Open Source`
...
* [Hidden Bar](https://github.com/dwarvesf/hidden) ⭐ 14,612 | 🐛 99 | 🌐 Swift | 📅 2026-06-15 - Hide menu bar items. `Free` `Open Source`
* [Dozer](https://github.com/Mortennn/Dozer) ⭐ 8,713 | 🐛 101 | 🌐 Swift | 📅 2023-11-30 - Hide menu bar icons to give your Mac a cleaner look. `Free` `Open Source`
...
* [Holeberry](https://github.com/pedrovieira/Holeberry) ⭐ 53 | 🐛 3 | 🌐 Swift | 📅 2026-08-22 - Monitor and control your Pi-hole instances from the menu bar. `Free` `Open Source`
...
* [Stats](https://github.com/exelban/stats) ⭐ 41,374 | 🐛 30 | 🌐 Swift | 📅 2026-08-21 - macOS system monitor. `Free` `Open Source`
* [MonitorControl](https://github.com/MonitorControl/MonitorControl) ⭐ 34,014 | 🐛 23 | 🌐 Swift | 📅 2026-08-11 - Control external monitor brightness & volume like native displays. `Free` `Open Source`
* [MonitorControl](https://github.com/MonitorControl/MonitorControl) ⭐ 34,014 | 🐛 23 | 🌐 Swift | 📅 2026-08-11 - Control external display brightness and volume. `Free` `Open Source`
...
* [AlDente](https://github.com/AppHouseKitchen/AlDente-Charge-Limiter) ⭐ 9,158 | 🐛 136 | 🌐 Swift | 📅 2026-08-03 - Charge limiter to extend MacBook battery life. `Freemium` `Open Source`
...
* [Neon Vision Editor](https://github.com/h3pdesign/Neon-Vision-Editor) ⭐ 387 | 🐛 4 | 🌐 Swift | 📅 2026-08-23 - A lightweight and modern macOS code editor. `Free` `Open Source`
...
* [Yabai](https://github.com/koekeishiya/yabai) ⭐ 29,497 | 🐛 250 | 🌐 C | 📅 2026-06-14 - Tiling window manager for macOS. `Free` `Open Source`
* [Loop](https://github.com/MrKai77/Loop) ⭐ 11,426 | 🐛 60 | 🌐 Swift | 📅 2026-08-09 - Window management made elegant. `Free` `Open Source`
