# Awesome Best MacOS Apps (2026) — Fast, Lightweight, No Electron (2026) with stars
...
**👨‍💻 Building a Mac app?** This list is for users discovering apps — if you're looking for where to *launch* one, see [Awesome Mac Launch Platforms](https://github.com/macnative/awesome-mac-launch-platforms) ⭐ 1 | 🐛 0 | 📅 2026-09-22 for submission platforms, subreddits, and newsletters, each tagged free or paid.
...
| [Maccy](https://github.com/p0deje/Maccy) ⭐ 21,701 \| 🐛 193 \| 🌐 Swift \| 📅 2026-09-04 | Clipboard history that just works. Never lose a copied item again.                                                 |
...
* [Stats](https://github.com/exelban/stats) ⭐ 42,082 | 🐛 30 | 🌐 Swift | 📅 2026-09-23 - macOS system monitor for CPU, GPU, memory, disk, and more. `Free` `Open Source`
...
* [BackgroundMusic](https://github.com/kyleneideck/BackgroundMusic) ⭐ 19,302 | 🐛 542 | 🌐 C++ | 📅 2026-06-10 - macOS audio utility to control volume per-app. `Free` `Open Source`
* [Petrichor](https://github.com/kushalpandya/Petrichor) ⭐ 1,686 | 🐛 18 | 🌐 Swift | 📅 2026-09-21 - Offline music player with support for over 20 file formats and a lot of other features. `Free` `Open Source`
...
* [Meeting Bar](https://github.com/leits/MeetingBar) ⭐ 5,348 | 🐛 142 | 🌐 Swift | 📅 2026-09-21 - Menu bar app for your calendar meetings. `Free` `Open Source`

## Clipboard Managers

* [Maccy](https://github.com/p0deje/Maccy) ⭐ 21,701 | 🐛 193 | 🌐 Swift | 📅 2026-09-04 - Lightweight clipboard manager with search. `Free` `Open Source`
* [Pesty](https://github.com/momenbasel/pesty) ⭐ 74 | 🐛 24 | 🌐 Swift | 📅 2026-09-24 - Native clipboard manager with pinboards and keyboard-driven pasting. `Free` `Open Source`
...
* [CodeEdit](https://github.com/CodeEditApp/CodeEdit) ⭐ 23,041 | 🐛 213 | 🌐 Swift | 📅 2026-08-18 - Native code editor for macOS. `Free` `Open Source`
* [DevCleaner](https://github.com/vashpan/xcode-dev-cleaner) ⭐ 1,613 | 🐛 19 | 🌐 Swift | 📅 2026-05-18 - Clean Xcode cache and derived data. `Free` `Open Source`
* [SSH Keys Manager](https://github.com/Stmol/ssh-keys-manager-macos-app) ⭐ 234 | 🐛 0 | 🌐 Swift | 📅 2026-07-03 - Native macOS app for managing SSH keys and SSH config entries. `Free` `Open Source`
...
* [Quick Look plugins](https://github.com/sindresorhus/quick-look-plugins) ⭐ 18,763 | 🐛 4 | 📅 2026-07-25 - Useful Quick Look plugins for developers. `Free` `Open Source`
...
* [Hidden Bar](https://github.com/dwarvesf/hidden) ⭐ 14,961 | 🐛 120 | 🌐 Swift | 📅 2026-09-23 - Hide menu bar items. `Free` `Open Source`
* [Dozer](https://github.com/Mortennn/Dozer) ⭐ 8,722 | 🐛 101 | 🌐 Swift | 📅 2023-11-30 - Hide menu bar icons to give your Mac a cleaner look. `Free` `Open Source`
* [Itsyhome](https://github.com/nickustinov/itsyhome-macos) ⭐ 990 | 🐛 19 | 🌐 Swift | 📅 2026-09-01 - Smart home meets menu bar. `Freemium` `Open Source`
...
* [Holeberry](https://github.com/pedrovieira/Holeberry) ⭐ 90 | 🐛 3 | 🌐 Swift | 📅 2026-09-23 - Monitor and control your Pi-hole instances from the menu bar. `Free` `Open Source`
...
* [Thaw](https://github.com/stonerl/Thaw) ⭐ 17 | 🐛 6 | 📅 2026-09-21 - Powerful menu bar management tool. Fork of Ice, lower resource usage. `Free` `Open Source`
...
* [Knopo](https://github.com/alkalim/Knopo) ⭐ 48 | 🐛 3 | 🌐 Swift | 📅 2026-09-14 - Local-first Markdown outliner with backlinks and queries. `Free` `Open Source`
...
* [Lockpaw](https://github.com/sorkila/lockpaw) ⭐ 152 | 🐛 3 | 🌐 Swift | 📅 2026-09-15 - Lock the screen while background tasks, builds, and AI agents keep running. `Free` `Open Source`
...
* [Stats](https://github.com/exelban/stats) ⭐ 42,082 | 🐛 30 | 🌐 Swift | 📅 2026-09-23 - macOS system monitor. `Free` `Open Source`
* [MonitorControl](https://github.com/MonitorControl/MonitorControl) ⭐ 34,305 | 🐛 25 | 🌐 Swift | 📅 2026-09-15 - Control external monitor brightness & volume like native displays. `Free` `Open Source`
* [MonitorControl](https://github.com/MonitorControl/MonitorControl) ⭐ 34,305 | 🐛 25 | 🌐 Swift | 📅 2026-09-15 - Control external display brightness and volume. `Free` `Open Source`
* [Background Music](https://github.com/kyleneideck/BackgroundMusic) ⭐ 19,302 | 🐛 542 | 🌐 C++ | 📅 2026-06-10 - Control audio per-application. `Free` `Open Source`
* [AlDente](https://github.com/AppHouseKitchen/AlDente-Charge-Limiter) ⭐ 9,182 | 🐛 153 | 🌐 Swift | 📅 2026-09-23 - Charge limiter to extend MacBook battery life. `Freemium` `Open Source`
* [ClearDisk](https://github.com/bysiber/cleardisk) ⭐ 705 | 🐛 12 | 🌐 Swift | 📅 2026-09-10 - macOS menu bar utility that monitors 44+ developer cache paths and helps reclaim disk space. `Free` `Open Source`
...
* [CodeEdit](https://github.com/CodeEditApp/CodeEdit) ⭐ 23,041 | 🐛 213 | 🌐 Swift | 📅 2026-08-18 - Native code editor for macOS. `Free` `Open Source`
* [VimR](https://github.com/qvacua/vimr) ⭐ 7,002 | 🐛 313 | 🌐 Swift | 📅 2026-09-20 - Neovim GUI for macOS. `Free` `Open Source`
* [Neon Vision Editor](https://github.com/h3pdesign/Neon-Vision-Editor) ⭐ 432 | 🐛 9 | 🌐 Swift | 📅 2026-09-24 - A lightweight and modern macOS code editor. `Free` `Open Source`
* [Itsypad](https://github.com/nickustinov/itsypad-macos) ⭐ 431 | 🐛 19 | 🌐 Swift | 📅 2026-08-15 - A tiny, fast scratchpad and clipboard manager. `Free` `Open Source`
...
* [Itsytv](https://github.com/nickustinov/itsytv-macos) ⭐ 634 | 🐛 3 | 🌐 Swift | 📅 2026-09-01 - The missing Apple TV remote app. `Free` `Open Source`
...
* [Yabai](https://github.com/koekeishiya/yabai) ⭐ 29,653 | 🐛 258 | 🌐 C | 📅 2026-06-14 - Tiling window manager for macOS. `Free` `Open Source`
* [Loop](https://github.com/MrKai77/Loop) ⭐ 11,665 | 🐛 70 | 🌐 Swift | 📅 2026-09-11 - Window management made elegant. `Free` `Open Source`
...
Beyond adding your app to this list, you can send it to us on [X (@best\_macapps)](https://x.com/best_macapps) for a chance at an individual spotlight post with a screenshot and writeup. [Follow the account](https://x.com/NativeMacApps) to catch new spotlights.

### Looking for More Places to Launch?

Getting your app into this list is one channel — for the full picture (Product Hunt-style platforms, relevant subreddits, other GitHub awesome lists, and newsletters that cover Mac apps), see [Awesome Mac Launch Platforms](https://github.com/macnative/awesome-mac-launch-platforms) ⭐ 1 | 🐛 0 | 📅 2026-09-22.
