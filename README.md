# Awesome Native macOS Apps — The Best Non-Electron Mac Software (2026) with stars
...
| [Maccy](https://github.com/p0deje/Maccy) ⭐ 21,186 \| 🐛 154 \| 🌐 Swift \| 📅 2026-08-13 | Clipboard history that just works. Never lose a copied item again.                                                 |
...
* [Stats](https://github.com/exelban/stats) ⭐ 41,235 | 🐛 24 | 🌐 Swift | 📅 2026-08-16 - macOS system monitor for CPU, GPU, memory, disk, and more. `Free` `Open Source`
* [Usage](https://usage.pro) - System activity monitor for macOS, iOS, and iPadOS. `Freemium`

## Audio & Music

* [BackgroundMusic](https://github.com/kyleneideck/BackgroundMusic) ⭐ 19,234 | 🐛 540 | 🌐 C++ | 📅 2026-06-10 - macOS audio utility to control volume per-app. `Free` `Open Source`
* [Petrichor](https://github.com/kushalpandya/Petrichor) ⭐ 1,600 | 🐛 25 | 🌐 Swift | 📅 2026-08-12 - Offline music player with support for over 20 file formats and a lot of other features. `Free` `Open Source`
...
* [Meeting Bar](https://github.com/leits/MeetingBar) ⭐ 5,305 | 🐛 133 | 🌐 Swift | 📅 2026-08-14 - Menu bar app for your calendar meetings. `Free` `Open Source`

## Clipboard Managers

* [Maccy](https://github.com/p0deje/Maccy) ⭐ 21,186 | 🐛 154 | 🌐 Swift | 📅 2026-08-13 - Lightweight clipboard manager with search. `Free` `Open Source`
* [Pesty](https://github.com/momenbasel/pesty) ⭐ 49 | 🐛 2 | 🌐 Swift | 📅 2026-08-12 - Native clipboard manager with pinboards and keyboard-driven pasting. `Free` `Open Source`
...
* [CodeEdit](https://github.com/CodeEditApp/CodeEdit) ⭐ 22,984 | 🐛 209 | 🌐 Swift | 📅 2026-08-04 - Native code editor for macOS. `Free` `Open Source`
...
* [SSH Keys Manager](https://github.com/Stmol/ssh-keys-manager-macos-app) ⭐ 214 | 🐛 0 | 🌐 Swift | 📅 2026-07-03 - Native macOS app for managing SSH keys and SSH config entries. `Free` `Open Source`
...
* [Quick Look plugins](https://github.com/sindresorhus/quick-look-plugins) ⭐ 18,736 | 🐛 4 | 📅 2026-07-25 - Useful Quick Look plugins for developers. `Free` `Open Source`
...
* [Hidden Bar](https://github.com/dwarvesf/hidden) ⭐ 14,580 | 🐛 99 | 🌐 Swift | 📅 2026-06-15 - Hide menu bar items. `Free` `Open Source`
...
* [Itsyhome](https://github.com/nickustinov/itsyhome-macos) ⭐ 981 | 🐛 22 | 🌐 Swift | 📅 2026-08-10 - Smart home meets menu bar. `Freemium` `Open Source`
...
* [OpenQuack](https://github.com/larryxiao/openquack) ⭐ 47 | 🐛 12 | 🌐 Swift | 📅 2026-07-23 - Transcribes a 5-minute clip in 2.8 s — local WhisperKit dictation, noise-robust. \~8 MB native Swift. `Free` `Open Source`
* [Holeberry](https://github.com/pedrovieira/Holeberry) ⭐ 39 | 🐛 1 | 🌐 Swift | 📅 2026-08-16 - Monitor and control your Pi-hole instances from the menu bar. `Free` `Open Source`
...
* [Thaw](https://github.com/stonerl/Thaw) ⭐ 5 | 🐛 6 | 📅 2026-08-15 - Powerful menu bar management tool. Fork of Ice, lower resource usage. `Free` `Open Source`
...
* [Knopo](https://github.com/alkalim/Knopo) ⭐ 24 | 🐛 0 | 🌐 Swift | 📅 2026-08-14 - Local-first Markdown outliner with backlinks and queries. `Free` `Open Source`
...
* [Little Snitch](https://www.obdev.at/products/littlesnitch/) - Network monitor and firewall. `Paid` `EU`
* [Lockpaw](https://github.com/sorkila/lockpaw) ⭐ 143 | 🐛 7 | 🌐 Swift | 📅 2026-08-10 - Lock the screen while background tasks, builds, and AI agents keep running. `Free` `Open Source`
...
* [Stats](https://github.com/exelban/stats) ⭐ 41,235 | 🐛 24 | 🌐 Swift | 📅 2026-08-16 - macOS system monitor. `Free` `Open Source`
* [MonitorControl](https://github.com/MonitorControl/MonitorControl) ⭐ 33,984 | 🐛 22 | 🌐 Swift | 📅 2026-08-11 - Control external monitor brightness & volume like native displays. `Free` `Open Source`
* [MonitorControl](https://github.com/MonitorControl/MonitorControl) ⭐ 33,984 | 🐛 22 | 🌐 Swift | 📅 2026-08-11 - Control external display brightness and volume. `Free` `Open Source`
* [Background Music](https://github.com/kyleneideck/BackgroundMusic) ⭐ 19,234 | 🐛 540 | 🌐 C++ | 📅 2026-06-10 - Control audio per-application. `Free` `Open Source`
...
* [ClearDisk](https://github.com/bysiber/cleardisk) ⭐ 575 | 🐛 12 | 🌐 Swift | 📅 2026-08-06 - macOS menu bar utility that monitors 44+ developer cache paths and helps reclaim disk space. `Free` `Open Source`
...
* [Itsypad](https://github.com/nickustinov/itsypad-macos) ⭐ 415 | 🐛 16 | 🌐 Swift | 📅 2026-08-15 - A tiny, fast scratchpad and clipboard manager. `Free` `Open Source`
* [Neon Vision Editor](https://github.com/h3pdesign/Neon-Vision-Editor) ⭐ 382 | 🐛 6 | 🌐 Swift | 📅 2026-08-17 - A lightweight and modern macOS code editor. `Free` `Open Source`
...
* [Yabai](https://github.com/koekeishiya/yabai) ⭐ 29,472 | 🐛 249 | 🌐 C | 📅 2026-06-14 - Tiling window manager for macOS. `Free` `Open Source`
* [Loop](https://github.com/MrKai77/Loop) ⭐ 11,374 | 🐛 58 | 🌐 Swift | 📅 2026-08-09 - Window management made elegant. `Free` `Open Source`
